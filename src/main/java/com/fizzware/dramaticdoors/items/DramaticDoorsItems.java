...
public class DramaticDoorsItems {
    ...
    public static void registerItems(final RegistryEvent.Register<Item> itemRegistry) {
        ...
        itemRegistry.getRegistry().registerAll(
            ...
            new TallDoorItem(DramaticDoorsBlocks.TALL_BYG_FLORUS_DOOR, conditionalTabProperties("byg")).setRegistryName(new ResourceLocation(DramaticDoors.MOD_ID, TallDoorBlock.NAME_BYG_FLORUS)),
            ...
            new TallDoorItem(DramaticDoorsBlocks.TALL_BYG_MANGROVE_DOOR, conditionalTabProperties("byg")).setRegistryName(new ResourceLocation(DramaticDoors.MOD_ID, TallDoorBlock.NAME_BYG_MANGROVE)),
